<?php
    ...
    $sql = "SELECT item.item_id, item.item_name, item.item_description, AVG(rating.rating_val) FROM item LEFT JOIN rating ON rating.item_id = item.item_id GROUP BY item.item_id";
